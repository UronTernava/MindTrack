      ...
      <section className={`relative p-8 mt-12 rounded-2xl shadow-xl overflow-hidden border-2 ${isDark ? 'bg-[#f3f4f6] text-[#23272e] border-[#bdbdbd]' : 'bg-[#23272e] text-[#f3f4f6] border-[#23272e]'}`}>
        ...
        <ul className="space-y-6">
          {resources.map((res, index) => (
            <ReleaseOnScroll key={res.title} delay={300 + (index * 100)}>
              <li className={`p-4 rounded-xl border-2 ${isDark ? 'bg-[#f3f4f6] text-[#23272e] border-[#bdbdbd]' : 'bg-[#181b20] text-[#f3f4f6] border-[#23272e]'}`}>
