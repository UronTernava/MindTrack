      ...
      <ReleaseOnScroll>
        <div className="w-full max-w-md p-8 rounded-2xl shadow-2xl border border-gray-200 dark:border-[#23272e] bg-white dark:bg-[#23272e]">
          <ReleaseOnScroll delay={200}>
            <h2 className="mb-6 text-3xl font-extrabold text-center text-[#3b82f6] dark:text-[#3ddc97]">Sign In</h2>
          </ReleaseOnScroll>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <ReleaseOnScroll delay={500}>
              <button type="submit" className="w-full py-2 mt-2 font-bold rounded-lg bg-[#3b82f6] dark:bg-[#3ddc97] text-white dark:text-[#23272e] hover:scale-105 transition-all shadow-md">Login</button>
            </ReleaseOnScroll>
          </form>
